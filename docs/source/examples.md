...
The examples of the whole input files for databases can be obtained from the `input` folder of *PyExoCross*'s ***GitHub*** : [https://github.com/nichollsh/PyExoCross](https://github.com/nichollsh/PyExoCross).
