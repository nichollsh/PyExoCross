...
# Ensure the src-layout package is importable without requiring an editable install
...
################## Could be changed ! ##################
# Directory that will hold the downloaded .par/.pf files and the generated
# hitran__urls.txt file (written under file_path/url/).
